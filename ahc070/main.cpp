            ...
            if (visited[at][bt]) {
                ...
                rep(i, 0, 3) {
                    if (!visited[candidates[i].first][candidates[i].second] 
                        ...
                        not_visited_candidates.emplace_back(i);
                    }
                }
                int r = -1;
                ...
                //total_distは何もしない
                //posyとposxを更新
                posy = candidates[r].first;
                posx = candidates[r].second;
                paper[t] = {posy, posx};
                //visitedをtrueに
                ...
                if (!israndom) {
                    ...
                    //7.posyとposxを更新
                    posy = candidates[mt].first;
                    posx = candidates[mt].second;
                    visited[posy][posx] = true;
                    paper[t] = {posy, posx};
                }
            }
